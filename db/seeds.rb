...
Post.create(id:"4" ,user_id: "12" ,title:"Busco testigo falso" ,city_id: "3" ,description: "El año pasado tuve un accidente automovilístico en el que choqué el frente de una casa. El dueño de esa casa me quiere llevar a juicio y estoy buscando evitarlo. Necesito de un/a abuelito/a que testifique a mi favor diciendo que choqué el frente de la casa por esquivarlo/a.")
Post.create(id:"5" ,user_id: "11" ,title:"Karl" ,city_id: "4" ,description: "Karl es mi perrito y necesita de alguien que lo cuide durante la primera quincena de enero que me voy de vacaciones. Es muy juguetón y muy buena compañía.",photo_url:"ej2.jpg")
Post.create(id:"6" ,user_id: "11" ,title:"Restaurar obra de arte" ,city_id: "6" ,description: "La imagen de la izquierda es la original y la de la derecha mi intento por restaurarla. ¿Alguien me haría la gauchada de acomodarla para que se parezca más a la original? ", photo_url:"ej3.jpg" )
Post.create(id:"7" ,user_id: "13" ,title:"Busco acompañante de viaje1" ,city_id: "5" ,description: "1 Soy camionero y busco una persona que me acompañe en mi viaje hasta Rawson porque sufro problemas de sueño. Saldríamos el primer fin de semana de octubre y retornaríamos el fin de semana siguiente. * Condición fundamental: debe cebar buenos mates")
Post.create(id:"8" ,user_id: "12" ,title:"Busco acompañante de viaje2" ,city_id: "6" ,description: "2 Soy camionero y busco una persona que me acompañe en mi viaje hasta Rawson porque sufro problemas de sueño. Saldríamos el primer fin de semana de octubre y retornaríamos el fin de semana siguiente. * Condición fundamental: debe cebar buenos mates")
