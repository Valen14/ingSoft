...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { name: @achievement.name, point_max: @achievement.point_max, point_min: @achievement.point_min } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { name: @achievement.name, point_max: @achievement.point_max, point_min: @achievement.point_min } }
